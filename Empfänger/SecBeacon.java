/** SecBeacon: Empfänger Beacon Klasse
*
*   Über diese Klasse werden die SecBeacons(gekürzter UUID und Mac) angelegt und gesteuert.
*   Unterschied von Sender und Empfänger SecBeacon.java -> veränderter Konstuktor für Klasse
*
...
class SecBeacon
{
  ...
  /**
  * Konstruktor SecBeacon 1
  * Flags werden festgelegt und nicht übergeben
  * @param uuid
  * @param mac
  * @param advertising
  */
  SecBeacon(String uuid, String mac, String advertising) {
    this.uuid = uuid;
    this.mac = mac;
  ...
  */
  public void sendAdv() throws Exception {
    ...
    try {
      ...
      System.out.println("Advertising Package gesendet!");}
  ...
  */
    public static String getMac (String message, String secKey, String algo){//(UUID+getTime(), Key, "HmacMD5")
    String output=null;
    try{
  ...
  */
   ...
   */
   ...
   public boolean verifyMac(){
     ...
     if(this.mac.equals(getMac(this.uuid+this.getTime(), this.key, "HmacMD5")))
     {
